...
.user-details .input-box input:valid{
 ...
 form .button input{
   ...
   cursor: pointer;
   transition: all 0.3s ease;
   background: linear-gradient(135deg, #244065, #244065);
 }
 form .button input:hover{
  /* transform: scale(0.99); */
  background: linear-gradient(-135deg, #889BB4, #889BB4);
  }
...
<body style="background-color:white;">
  <div class="container" style="background-color:white;      margin-top: 8em;">
      ...
      <form action="book_nowbk.php" method="POST" enctype="multipart/form-data">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="file" style="padding:5px;" name="image" placeholder="" required>
          </div>
          <div class="input-box">
    <span class="details">Appointment Date</span>
    <input type="date" name="ap_date" id="ap_date" placeholder="" required>
</div>


        <div class="input-box" >
            <span class="details">Appointment Time</span>
            <select name="ap_time" style="width:300px; height:42px;border-radius:5px;padding:10px;" required>
            <option value="select">select time</option>
              <option value="11:00">10:00 AM - 11:00 PM</option>
        ...
        <div class="button" style="background-color:#244065;     margin-left: 217px;
}">
          <input  type="submit" style="width: 152px;" value="Book Now">
        </div>
      </form>
    </div>
  </div>
  <script>
    ...
    document.getElementById('ap_date').setAttribute('min', currentDate);
</script>
</body>
</html>