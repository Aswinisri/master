				...
				<div class="row">
					...
					<div class="col-md-6">
						<form action="user_registerbk.php" method="POST" enctype="multipart/form-data" id="validateForm">
							...
							<input name="post" type="submit" class="btn btn-block btn-success" value="Register"  style=" background-color: #244065; border-color:#244065; color:white; justify-content:center;" />
							<br>
							<a href="Ulogin.php" style="text-align:center; text-decoration:none; color:black;"><p>Already have a account? Login</p></a>
