...
<header id="site-header" class="fixed-top" style="background-color:#244065;">
  ...
  <div class="container">
      <nav class="navbar navbar-expand-lg stroke p-0">
          <h1> <a  style="color:white;" class="navbar-brand" href="#">
                 Lawyer Up
              </a></h1>
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-lg-5 mr-lg-auto">
                  ...
                  <li class="nav-item @@contact__active">
                      <a class="nav-link"  style="color:white;" href="Ulogin.php">Logout</a>
                  </li>
              </ul>
...
// Check if the category name is set in the URL
if (isset($_GET['case_handle'])) {
    $categoryName = $_GET['case_handle'];

    // Query to select all images from the table for the specific category
    $sql = "SELECT * FROM lawyer WHERE case_handle = '$categoryName'";
    $result = $conn->query($sql);

    echo '<h1 style="text-align:center; padding:10px;">'.ucwords($categoryName).'</h1>';
    ...
    if ($result->num_rows > 0) {
        ...
        echo 'No lawyers found in the specified category.';
    }
} else {
