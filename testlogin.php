				...
				<div class="row">
					...
					<img src="login.png">
						<form action="Uloginbk.php" method="POST"  id="validateForm">
							...
							<input name="login" type="submit" class="btn btn-block btn-success" value="Login"  style=" background-color: #244065; align-item:center; justify-content:center; color:white;"
/><br>
							<!--after signup redirect user dashboard page-->
							<a href="user_register.php" style="text-align:center; text-decoration:none; color:black;"><p>Do not have a account? signup</p></a>
						</form>
					</div>
				</div>
			</div>
